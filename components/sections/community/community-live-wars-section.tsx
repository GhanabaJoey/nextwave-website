...
export function CommunityLiveWarsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-24 lg:grid lg:grid-cols-12 lg:items-center lg:gap-14 lg:px-10 lg:py-32 xl:gap-16">
        <figure className="relative lg:col-span-6">
          <div className="relative overflow-hidden rounded-xl ring-1 ring-white/10">
            <div className="relative aspect-4/3 min-h-[280px] sm:min-h-[360px] lg:min-h-[420px]">
              <Image
                src={image.src}
                alt={image.alt}
                fill
